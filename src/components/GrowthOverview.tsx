...
export const GrowthOverview: React.FC = () => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-[1fr_1.5fr] gap-4">
      ...
      <div className="flex flex-col justify-between rounded-md bg-surface p-5 border border-border shadow-[0_4px_20px_-4px_rgba(28,38,33,0.04)]">
        ...
        <div className="flex items-center gap-4.5 my-2">
          <div className="relative flex items-center justify-center">
            ...
            <div className="absolute flex flex-col items-center justify-center">
              <Sprout className="w-5 h-5 text-accent-sage" />
            </div>
          </div>
      ...
      <div className="rounded-md bg-surface p-5 border border-border shadow-[0_4px_20px_-4px_rgba(28,38,33,0.04)]">
        ...
        <div className="grid grid-cols-7 sm:grid-cols-14 gap-1.5 pt-1">
          {heatmapCells.map((cell, idx) => {
            ...
            const levelClasses = {
              ...
              1: 'bg-[#D2E7DC] hover:border-accent-sage',
              2: 'bg-[#96CBB0] hover:border-accent-sage',
              3: 'bg-[#528B70] hover:border-primary',
            ...
            return (
              <div
                key={idx}
                className={`aspect-square rounded-xs transition-transform duration-150 cursor-pointer hover:scale-125 border border-transparent ${levelClasses} ${
                  cell.isToday ? 'ring-2 ring-accent-amber ring-offset-1' : ''
                }`}
        ...
        <div className="flex items-center justify-between text-[11px] text-text-tertiary mt-3 pt-1 border-t border-border-subtle">
          ...
          <div className="flex items-center gap-1">
            ...
            <span className="w-2.5 h-2.5 rounded-xs bg-[#528B70]" />
